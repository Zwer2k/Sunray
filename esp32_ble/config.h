...
#define WIFI_STA_SSID   "mein!SH"      // WiFi SSID      (leave empty ("") to not use WiFi)
#define WIFI_STA_PSK    "JhrtJG243SS836WtnbV"  // WiFi password  (leave empty ("") to not use WiFi)
...
#define MQTT_HOSTNAME   "192.168.44.7"  // IP or hostname (example: "192.168.2.60")
#define MQTT_PORT       1883
#define MQTT_CLIENT_ID  NAME
#define MQTT_USERNAME   "default"
#define MQTT_PASSWORD   "K7B3TGI3p5"
